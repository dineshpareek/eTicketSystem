        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePic = table.Column<string>(type: "varchar(200)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RefId = table.Column<string>(type: "varchar(200)", nullable: true),
                    ImageURL = table.Column<string>(type: "varchar(200)", nullable: false),
                    Title = table.Column<string>(type: "varchar(200)", nullable: true),
                    fullTitle = table.Column<string>(type: "varchar(200)", nullable: true),
                    Description = table.Column<string>(type: "varchar(200)", nullable: false),
                    crew = table.Column<string>(type: "varchar(200)", nullable: true),
                    Year = table.Column<int>(type: "int", nullable: true),
                    ImDbRatingCount = table.Column<int>(type: "int", nullable: true),
