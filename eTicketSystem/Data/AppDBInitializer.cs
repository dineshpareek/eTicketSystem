...
namespace eTicketSystem.Data
{
    public static class AppDBInitializer
    {
        ...
        {
            using (var context = new ETicketDBContext(
                serviceProvider.GetRequiredService<
                    DbContextOptions<ETicketDBContext>>()))
            {
                if (context == null || context.Movies == null)
                {
                    throw new ArgumentNullException("Null ETicketDBContext");
                }
                ...
                if (!context.Actors.Any())
                {
                    context.Actors.AddRange(new List<Actor>()
                    {
                        ...
                        {
                            Name = "Actor 1",
                            Info = "This is the Info of the first actor",
                        ...
                        {
                            Name = "Actor 2",
                            Info = "This is the Info of the second actor",
